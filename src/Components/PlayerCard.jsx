...
const PlayerCard = () => {
  return (
    <div className="grid grid-rows-6 border-2 w-80 mr-6 bebas-neue-regular rounded-xl bg-gradient-to-tr from-orange-400 to-orange-700">
      <div className="flex flex-col justify-center row-span-2 p-4 text-center">
        ...
        <div className="">
          <h1 className="text-5xl font-bold">{`${fakeUser.first_name} ${fakeUser.last_name}`}</h1>
        </div>
      </div>
